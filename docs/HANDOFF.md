...
| 2026-09-04 | W7.7 sound design + micro-motion | none | 0.00 | 0.00 | Ten effects synthesised by `video/capture/sfx.py` (numpy, seeded; no recordings, no licences) into `video/public/sfx/`; attached per visual event by the drawing components, plus a cut tick and act whoosh from the timeline. Act A reopened as a six-crop photo burst with shutters; pricing and Reddit tool pages zoom toward their subject; the cast shot punches in. Cut length unchanged (74.4 s). |
